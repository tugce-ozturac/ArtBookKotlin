...
import com.tugce.artbookkotlin.databinding.ActivityArtBinding
...
class ArtActivity : AppCompatActivity() {
    ...
    fun saveButtonClicked(view: View) {
        ...
        if (selectedBitmap != null) {
            ...
            intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP) //bundan önce ne kadar açık aktvite varsa kapat
        ...
        if(Build.VERSION.SDK_INT>= Build.VERSION_CODES.TIRAMISU){
            if (ContextCompat.checkSelfPermission(
                ...
                if (ActivityCompat.shouldShowRequestPermissionRationale(
                    ...
                    Snackbar.make(view, "Permission nedded Gallery!", Snackbar.LENGTH_INDEFINITE)
            ...
            permissionLauncher =
                registerForActivityResult(ActivityResultContracts.RequestPermission()) { result ->
                    if (result) {
                        ...
                        //permission denied
                        Toast.makeText(this@ArtActivity, "Permisson needed!", Toast.LENGTH_LONG)
                            .show()
                    }
                }
